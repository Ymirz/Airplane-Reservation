 ...
 * @author Myles
 */
public class AIRPLANE_RESERVATION_SEAT_ASSIGNMENT {
    ...
    private Button listBtn = new Button("Display List");
    ...
    AIRPLANE_RESERVATION_SEAT_ASSIGNMENT(LinkedList customerInfo) {
        ...
        window.setTitle("AIRPLANE RESERVATION - SEARCH SEAT ASSIGNMENT");
        window.show();
    }
    ...
    public void setListBtn(Button btn, LinkedList customerInfo) {
        btn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                isFound = customerInfo.search(findSeatNum, findFirstName, findLastName, isFound);

                if (isFound) {
                    txtArea.appendText("[Seat Assignment: " + findSeatNum + "] First name: " + findFirstName + " Last Name: " + findLastName);
                } else {
